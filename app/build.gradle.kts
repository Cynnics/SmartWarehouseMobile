...
android {
    namespace = "com.smartwarehouse.mobile"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.smartwarehouse.mobile"
        minSdk = 26
        targetSdk = 36
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    // Compose (de tu configuración original)
    ...
    // Core Android (para Activities tradicionales)
